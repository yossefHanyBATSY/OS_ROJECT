...
public class AppLauncher extends JFrame {
	...
	private BankSystemRealWorld diningApp;
	...
	public AppLauncher() {
		...
		diningApp = new BankSystemRealWorld();
		...
		JLabel lblPhilosopher_1 = new JLabel("Account #1");
		...
		JLabel lblPhilosopher_2 = new JLabel("Account #2");
		...
		JLabel lblPhilosopher_3 = new JLabel("Account #3");
		...
		JLabel lblPhilosopher_4 = new JLabel("Account #4");
		...
		JLabel lblPhilosopher = new JLabel("Account #5");
		...
		JLabel lblFork_1 = new JLabel("key #1");
		...
		JLabel lblFork_2 = new JLabel("key #2");
		...
		JLabel lblFork_3 = new JLabel("key #3");
		...
		JLabel lblFork_4 = new JLabel("key #4");
		...
		JLabel lblFork_5 = new JLabel("key #5");
		...
		txtrObserveTheDining.setText("Bank transaction system in which include various accounts each of them has a key,and the system can execute transactions,\nto execute the transaction the thread must lock both keys during the transaction process so the transaction could be\ndone from one account to another.\n\n");
		txtrObserveTheDining.setBounds(40, 11, 843, 141);
		contentPane.add(txtrObserveTheDining);
		JLabel lblZzz1 = new JLabel("Waiting");
		lblZzz1.setVisible(false);
		lblZzz1.setBounds(668, 206, 120, 14);
		zzzList.add(lblZzz1);
		contentPane.add(lblZzz1);
		
		JLabel lblZzz2 = new JLabel("Waiting");
		lblZzz2.setVisible(false);
		lblZzz2.setBounds(715, 402, 120, 14);
		zzzList.add(lblZzz2);
		contentPane.add(lblZzz2);
		
		JLabel lblZzz3 = new JLabel("Waiting");
		lblZzz3.setVisible(false);
		lblZzz3.setBounds(535, 501, 120, 14);
		zzzList.add(lblZzz3);
		contentPane.add(lblZzz3);
		
		JLabel lblZzz4 = new JLabel("Waiting");
		lblZzz4.setVisible(false);
		lblZzz4.setBounds(337, 402, 120, 14);
		zzzList.add(lblZzz4);
		contentPane.add(lblZzz4);
		
		JLabel lblZzz5 = new JLabel("Waiting");
		lblZzz5.setVisible(false);
		lblZzz5.setBounds(382, 206, 120, 14);
		zzzList.add(lblZzz5);
		contentPane.add(lblZzz5);
		
		JLabel lblFinishedEating1 = new JLabel("All Transactions done successfully");
		...
		JLabel lblFinishedEating2 = new JLabel("All Transactions done successfully");
		...
		JLabel lblFinishedEating3 = new JLabel("All Transactions done successfully");
		...
		JLabel lblFinishedEating4 = new JLabel("All Transactions done successfully");
		...
		JLabel lblFinishedEating5 = new JLabel("All Transactions done successfully");
	...
	private void startDining() {
		...
		timer.scheduleAtFixedRate(new TimerTask() {
			@Override
			public void run() {
				for(Accounts philosopher : diningApp.getPhilosophers()){
	...
	protected void timeForBed(Accounts philosopher) {
	...
	private void wakeUp(Accounts philosopher) {
		switch (philosopher.getName()) {
		case "Philosopher: 1":
	...
	private void putToSleep(Accounts philosopher) {
		switch (philosopher.getName()) {
		case "Philosopher: 1":
	...
	private void changeColourToBlack(Accounts philosopher) {
		switch (philosopher.getName()) {
		case "Philosopher: 1":
	...
	private void changeColourToGreen(Accounts philosopher) {
		switch (philosopher.getName()) {
		case "Philosopher: 1":
